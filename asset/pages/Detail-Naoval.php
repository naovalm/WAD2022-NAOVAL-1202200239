...
<html lang="en">
  ...
  <div class="container mt-5">
    <h1 style="text-align: left;"><b>BMWM4</b></h1>
    <p style="text-align: left;">Detail Mobil</p>
  </div>
</div>
    </div>
    <div class="col">
...
<div class="container">
  ...
  <button type="submit" name="Submit" class="btn btn-primary col-2 mt-3"><span>Edit</span></button>
