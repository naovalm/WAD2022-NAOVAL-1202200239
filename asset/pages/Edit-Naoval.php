...
<html lang="en">
  ...
  <div class="container mt-5">
    <h1 style="text-align: left;"><b>EDIT</b></h1>
    <p style="text-align: left;">EDit Detail Mobil</p>
  </div>
</div>
    </div>
    <div class="col">
...
<div class="container">
  <div class="row">
    <div class="col mt-5">
      <img src="images/mustang.png" class="rounded float-start" alt="..." width="600px" height="500px">
    </div>
    <div class="col">
    <section id="form">
        <br></br>
  ...
  <button type="submit" name="Submit" class="btn btn-primary col-2 mt-3"><span>Simpan</span></button>
